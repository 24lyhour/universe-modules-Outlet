...
import type { OutletEditProps } from '../../../types';
            ...
            <div class="flex items-start gap-3 rounded-lg border border-destructive/50 bg-destructive/10 p-4">
                ...
                <div class="space-y-1">
                    <p class="text-sm font-medium text-destructive">
                        You are about to delete this outlet
                    </p>
                    <p class="text-sm text-muted-foreground">
                        <strong>{{ outlet.name }}</strong> will be permanently removed.
                    </p>
                </div>
            </div>
